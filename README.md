...
- Resultados y posiciones en las carreras  
...
1. Clonar el repositorio o descargar el archivo .zip desde GitHub.  
   git clone https://github.com/ReyCabello/proyecto_prueba.git
